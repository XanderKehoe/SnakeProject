...
public class Menu extends Game implements Scene{
	...
	public Menu(int sizeX, int sizeY) {
		...
		menuG = new SimpleMenu(Game.ui.getWidth() / 2 - 50, 10, 30, 20, "MAIN MENU");
		menuG.addItem(new SimpleMenu.SelectableText(30, 40, 20, 20, "Start (easy)", 1, 0, 0, 1, 1, 1), new SnakeGame(40));
